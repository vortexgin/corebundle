...
class StringUtils
{
     ...
     * @param string  $type   Type of randomize string
     * 
     * @return string
     */
     ...
     * @return boolean
     */
    static public function isSerialized($value, &$result = null)
    {
     ...
     * 
     * @param string $str       String to generate
     * @param int    $startPos  Start position
     * @param int    $maxLength Max length of excerpt
     * 
     * @return string 
     */
     ...
     * @return array 
     */
    public static function tokenizer($string, $lang = 'id')
    {
        $id = self::$id;
        $en = self::$en;
